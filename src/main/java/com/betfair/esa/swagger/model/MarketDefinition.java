...
import com.betfair.esa.swagger.model.KeyLineDefinition;
import com.betfair.esa.swagger.model.PriceLadderDefinition;
...
public class MarketDefinition {
  ...
  public enum BettingTypeEnum {
    ...
    public static BettingTypeEnum fromValue(String input) {
    ...
    public static class Adapter extends TypeAdapter<BettingTypeEnum> {
      ...
      public BettingTypeEnum read(final JsonReader jsonReader) throws IOException {
        ...
        return BettingTypeEnum.fromValue((String)(value));
      }
    }
